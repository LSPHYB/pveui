...
) ENGINE=InnoDB AUTO_INCREMENT=27906 DEFAULT CHARSET=utf8mb4;


-- pve.auth_permission 定义
...
-- pve.auth_user_user_permissions 定义
...
-- pve.rbac_role_custom_data_organizations 定义
...
-- pve.chat_chatconversationsummary 定义
...
-- pve.experiments_courseexperiment 定义
...
-- pve.experiments_courseguidebook 定义
...
-- pve.experiments_coursesubmission 定义
...
-- pve.chat_aiknowledgeindexstatus 定义
...
-- pve.chat_chatexperimentcontext 定义
...
-- pve.experiments_courseattachment 定义
